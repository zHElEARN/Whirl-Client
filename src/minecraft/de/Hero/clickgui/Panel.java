...
public class Panel {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		if(Whirl.instance.setmgr.getSettingByName("Design").getValString().equalsIgnoreCase("New")){
		...
		}else if(Whirl.instance.setmgr.getSettingByName("Design").getValString().equalsIgnoreCase("JellyLike")){
		...
		if (this.extended && !Elements.isEmpty()) {
			...
			int epanelcolor = Whirl.instance.setmgr.getSettingByName("Design").getValString().equalsIgnoreCase("New") ? 0xff232323 : Whirl.instance.setmgr.getSettingByName("Design").getValString().equalsIgnoreCase("JellyLike") ? 0xbb151515 : 0;;
