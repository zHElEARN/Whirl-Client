...
import tech.mcwhirl.commands.impl.Bind;
import tech.mcwhirl.commands.impl.LoadBinds;
import tech.mcwhirl.commands.impl.Modules;
import tech.mcwhirl.commands.impl.SaveBinds;
...
public class CommandManager {
	...
	public CommandManager() {
		...
		addCommand(new Modules("modules", "List all modules."));
		addCommand(new Bind("bind", "Bind key to module."));
		addCommand(new SaveBinds("save", "Save binds"));
		addCommand(new LoadBinds("load", "Load binds"));
	}
