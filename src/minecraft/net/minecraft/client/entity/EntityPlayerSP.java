...
import tech.mcwhirl.utils.PlayerUtils;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    {
    	if (Whirl.instance.commandManager.execute(p_71165_1_) || p_71165_1_.startsWith(Whirl.instance.commandManager.Chat_Prefix)) {
    		return;
    	}
    ...
    public void onLivingUpdate()
    {
        ...
        {
        	if (Whirl.instance.moduleManager.getModuleByName("NoSlow").isEnabled()) {
