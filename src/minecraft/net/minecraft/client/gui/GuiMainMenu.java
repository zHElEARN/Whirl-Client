...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
    	...
    	this.mc.getTextureManager().bindTexture(new ResourceLocation("Whirl/MainBackground.jpg"));
    	...
    	Fonts.menuWhirl.drawString(Whirl.instance.Client_Name + " " + Whirl.instance.Client_Version, width / 2 - (Fonts.menuWhirl.getStringWidth(Whirl.instance.Client_Name + " " + Whirl.instance.Client_Version) / 2 - 0) - 2, height / 4 + 60 - 70, ColorUtils.rainbowEffeckt(200000000L, 1F).getRGB());
